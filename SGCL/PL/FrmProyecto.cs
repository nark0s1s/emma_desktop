...
namespace SGCL.PL
{
    public partial class FrmProyecto : Form
    {
        ...
        {
            int oid = new int();
            FrmProyectoAdd oFrm = new FrmProyectoAdd(this,oid,"C");
            oFrm.ShowDialog();
        }
        ...
        private void btnEditar_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.RowCount > 0)
            {
                ...
                FrmProyectoAdd oFrmAdd = new FrmProyectoAdd(this,oid,"U");
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            if (dgv.RowCount > 0)
            {
                ...
                FrmProyectoAdd oFrmAdd = new FrmProyectoAdd(this, oid,"R");
