...
namespace SGCL.PL
{
    public partial class FrmComedorTipoServicioAdd : Form
    {

        private string mod;
        private int oid;
        private FrmComedorTipoServicio oFrm;

        public FrmComedorTipoServicioAdd()
        {
            InitializeComponent();            
        }
        ...
        */
        ...
        private void btnGrabar_Click(object sender, EventArgs e)
        {
            ...
            oBE.tipo_cod_tipo_serv_come = rvTipoServ["Codigo"].ToString();
            ...
            oBE.imp_prec_fact = Decimal.Parse(txtPrecioFactura.Text);
            ...
            {
                oBE.oid_come_tipo_serv = Int32.Parse(txtOid.Text);
                oBR.Actualizar(oBE);
            }
